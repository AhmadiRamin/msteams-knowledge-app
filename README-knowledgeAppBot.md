# knowledge app Bot - `knowledgeAppBot`
...
3. Give the bot a handle (ex: `knowledgeAppBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://devknowledgeapp.azurewebsites.net/api/messages`
